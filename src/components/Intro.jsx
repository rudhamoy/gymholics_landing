...
const Intro = () => {
  return (
    <div className="heading p-3">
      ...
      <p className="text-base font-semibold my-5 uppercase text-gray-600">You can actually achieve your GOAL in <br/><span className="text-orange-600 text-2xl">70 days</span> or less!</p>

      <p className="font-semibold p-2 my-10 border rounded-md shadow-md">Fill up the form below and get up to <span className="text-2xl text-cyan-600">40%</span> discounts/offers.</p>

      <p className="p-2 mt-6"><span className="font-semibold text-xl">Gymholics</span> is a personalized trainer & instructor focusing on customized and flexible gym programs for your goals and needs, whether that's weight loss, muscle building or just general fitness.</p>
      <br />
