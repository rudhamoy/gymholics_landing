        ...
        <div className="h-[60vh] sm:h-[90vh] overflow-x-hidden sm:overflow-x-visible">
            <div className="flex justify-center items-center h-[90%] sm:h-[95%] w-[100vw] bg-[#C2CFD6] relative">
                ...
                <div className="mt-36 z-40">
                    ...
                    <p className="text-xs text-gray-600 font-semibold">offers valid till 10th Oct, <br/> for first 20 new members only! <span className="text-orange-600">7 left</span></p>
                </div>

                <img src="tinywow_gymholics3_50.png" alt="" className="h-[430px] sm:h-[600px] absolute left-24 sm:left-[50%] z-10 dropShadow" />

                <div className="rounded-md bg-white p-3 sm:p-4 shadow-md absolute left-6 sm:left-60 top-16 heading ">
                    <p className="font-semibold text-sm">Get Offers <br />upto <span className="text-3xl font-bold text-yellow-500">40%</span></p>
                </div>
            </div>
        </div>
    )
